        ...
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 text-black font-serif">
            <div className="w-full flex flex-col items-center justify-center sm:flex-row sm:items-center sm:justify-between font-serif">
                <a href="/" className="flex items-center mb-4 sm:mb-0">
                    ...
                    alt="Labseq logo"
                    />
                    <span className="self-center text-xl  whitespace-nowrap hover:scale-105">Altice Labs Exercise</span>
                </a>
            ...
            <div className='w-full flex items-center justify-center'>
                <span className="block text-sm sm:text-center ">© 2024 <a href="/" className="hover:underline">Altice Labs Exercise™</a>. All Rights Reserved.</span>
            </div>
        </div>
    </footer>
